...
class Module extends \kartik\base\Module
{
    ...
    public function init()
    {
        ...
        $nodeActions += [
            self::NODE_MANAGE => Url::to(['/treelist/node/manage']),
            self::NODE_SAVE => Url::to(['/treelist/node/save']),
            self::NODE_REMOVE => Url::to(['/treelist/node/remove']),
            self::NODE_MOVE => Url::to(['/treelist/node/move']),
        ];

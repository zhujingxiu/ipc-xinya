...
namespace system\treelist\models;
...
use system\treelist\TreeListView;
use creocoder\nestedsets\NestedSetsBehavior;

/**
 * Trait that must be used by the Tree model
 */
class TreeList extends ActiveRecord
{
    ...
    public function initDefaults()
    {
        ...
        extract($module->dataStructure);
        $this->setDefault($iconTypeAttribute, TreeListView::ICON_CSS);
